...
@forms_router.post("/custom-fields", response_model=CustomFieldResponse, dependencies=[Depends(get_current_org_admin)])
...
@forms_router.delete("/custom-fields/{field_id}", dependencies=[Depends(get_current_org_admin)])
...
@forms_router.post("/templates", response_model=UpdateFormResponse, dependencies=[Depends(get_current_org_admin)])
...
@forms_router.post("/templates/{form_id}/send", dependencies=[Depends(get_current_org_admin)])
...
@forms_router.get("/submissions", response_model=List[SubmissionResponse], dependencies=[Depends(get_current_org_admin)])
...
@forms_router.post("/submissions/{submission_id}/approve", dependencies=[Depends(get_current_org_admin)])
...
@forms_router.post("/submissions/{submission_id}/reject", dependencies=[Depends(get_current_org_admin)])
