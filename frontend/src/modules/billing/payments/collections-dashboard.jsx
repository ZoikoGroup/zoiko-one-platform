...
import {
  ...
  PieChart as PieChartIcon, Users, TrendingUp, HandCoins,
} from "lucide-react";
import {
...
export default function CollectionsDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className={DASHBOARD_KPI_GRID}>
        <EnterpriseStatCard title="Amount Collected" value={formatDisplayCurrency(collectionsStats.amount_collected || 0, "—", baseCurrency)} icon={CheckCircle} color={CARD_GRADIENTS[1]} />
      ...
      <div className={DASHBOARD_CHART_GRID}>
        ...
        <ChartCard title="Collections Priority Distribution">
          <ChartErrorBoundary aria-live="polite">
            ...
            ) : <EmptyStateWidget message="No collections cases" icon={PieChartIcon} />}
          </ChartErrorBoundary>
        </ChartCard>
      </div>
