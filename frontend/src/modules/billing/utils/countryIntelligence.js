...
export const COUNTRY_DEFAULTS = {
  India: {
    ...
    number_formats: {
      invoice: { prefix: "INV-", format: "PREFIX-{YYYY}-{SEQ}", example: "INV-2026-000001" },
      quote: { prefix: "QTE-", format: "PREFIX-{YYYY}-{SEQ}", example: "QTE-2026-000001" },
      credit_note: { prefix: "CN-", format: "PREFIX-{YYYY}-{SEQ}", example: "CN-2026-000001" },
      refund: { prefix: "RF-", format: "PREFIX-{YYYY}-{SEQ}", example: "RF-2026-000001" },
    },
  },
  "United States": {
