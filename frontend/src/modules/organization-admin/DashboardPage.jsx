  ...
  function renderKpi(kpi) {
    ...
    return (
      <StatCard
        ...
        label={kpi.label}
        value={val}
        sub={kpi.key === "active_employees" ? `of ${totalEmployees} total headcount` : kpi.key === "departments" ? "Engineering leads headcount" : kpi.key === "monthly_payroll" ? "Disburses Aug 1, 2026" : null}
        trendIcon={TrendIcon}
