...
export default function PayslipsPage() {
  ...
  // Period options are derived from what the backend actually returns,
  // rather than a hardcoded list of periods.
                  ...
                  <tr key={p.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => setSelectedPayslip(p)} className="p-1.5 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100">
