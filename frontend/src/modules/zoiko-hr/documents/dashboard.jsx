...
import { FileText, Clock, AlertTriangle, CheckCircle, XCircle, TrendingUp, RefreshCw } from "lucide-react";
...
export default function DocumentsDashboard() {
  ...
  const statCards = [
    ...
    { label: "Expired",         value: expired,  Icon: AlertTriangle, bg: "bg-slate-100",  text: "text-slate-500",   border: "border-l-4 border-slate-400"   },
    { label: "Approval Rate",
    ...
    <HRPage title="Documents Overview">
      <div className="space-y-8 pb-10">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl p-6 text-white flex items-center justify-between">
          ...
          <button
            onClick={load}
            className="flex items-center gap-2 text-xs font-semibold bg-white/20 hover:bg-white/30 px-3 py-2 rounded-lg transition-colors"
          >
